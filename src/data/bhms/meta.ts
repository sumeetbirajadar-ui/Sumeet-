...
export const BHMS_CATEGORY_OPTIONS_BY_QUOTA: Record<QuotaType, CategoryOption[]> = {
  GOVT: buildCategoryOptions(BHMS_CATEGORY_CODES_BY_QUOTA.GOVT),
  PRIV: buildCategoryOptions(BHMS_CATEGORY_CODES_BY_QUOTA.PRIV),
  NRI: buildCategoryOptions(BHMS_CATEGORY_CODES_BY_QUOTA.NRI),
  OTHERS: buildCategoryOptions(BHMS_CATEGORY_CODES_BY_QUOTA.OTHERS),
};
